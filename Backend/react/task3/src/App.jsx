...
export default function Task10() {
  ...
  return (
    <div className="container mt-4">
      <h3 className="text-center" >Customer <span className="text-success">Registration</span></h3>
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        <button className='form-control' type="submit" className="btn btn-primary">Register</button>
      </form>
    </div>
  );
}
